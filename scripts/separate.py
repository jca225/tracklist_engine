...
(Python API, reliable output tracking — not CLI globbing):
  ...
  - `both`   : run both into separate folders so you can compare the vocals
...
def main() -> int:
    ...
    ap.add_argument("--separator", choices=["uvr", "demucs", "both"], default="uvr")
    ap.add_argument("--config", type=Path, default=None,
                    help="UVR chain yaml (default: analysis/uvr_chain.yaml)")

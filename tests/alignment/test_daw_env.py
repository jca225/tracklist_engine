...
from alignment.daw_env.actions import (  # noqa: E402
    EscalateHuman,
    NudgeSetStart,
    PlaceSpan,
    RenderListen,
...
from alignment.daw_env.als_mutate import (  # noqa: E402
    make_minimal_als,
    sync_span_to_als,
)
from alignment.daw_env.loop import resolve_daw  # noqa: E402
from alignment.daw_env.session import (  # noqa: E402
    DAW_REACT_SUFFIX,
    DawSession,
    SpanGeom,
)
...
def test_content_target_prefers_fp_over_cue() -> None:
    ...
    from alignment.daw_env.sense import content_target_set_start
...
def test_propose_nudge_toward_content() -> None:
    from alignment.agentic.belief import Observation, SpanBelief
    from alignment.daw_env.loop import _propose_nudge

...
Usage
-----
    venvs/audio/bin/python -m pws_aligner.run_phase1 --set-id <id>
    ...
    *,
    ...
    if not votes_path.exists():
        sys.exit(
            ...
            "See pws_aligner/run_phase1.py for the votes-file schema."
        )
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument(
        ...
        type=Path,
        default=None,
        help="output directory (default: alignment/out/)",
    )
    p.add_argument(
        "--bin-s",
        type=float,

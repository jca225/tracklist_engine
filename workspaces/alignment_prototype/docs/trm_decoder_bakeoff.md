...
- Existing decoder + harness: [`workspaces/alignment_prototype/trajectory/`](../trajectory/)
  (`model.py`, `data.py`, `features.py`, `targets.py`, `synthetic_adapter.py`, `decode.py`, `train.py`).
- Canonical decode coords + scorer: [`workspaces/alignment_prototype/path_decode.py`](../path_decode.py)
  (`_viterbi`, `trajectory_acc`).
- Synthetic generator: `workspaces/alignment_prototype/synthetic_mix/` (`generate_v2`).

...
from workspaces.alignment_prototype.looptrace.config import RES_V1, ResidualConfig
from workspaces.alignment_prototype.looptrace.segments import Diagonal

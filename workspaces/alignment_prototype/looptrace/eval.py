...
Usage:
    venvs/audio/bin/python -m workspaces.alignment_prototype.looptrace.eval \
...
from workspaces.alignment_prototype.looptrace.audit import clone_images  # noqa: E402
from workspaces.alignment_prototype.looptrace.config import EVAL_V1  # noqa: E402

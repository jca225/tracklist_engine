...
Run:  venvs/audio/bin/python -m workspaces.alignment_prototype.measure_detune
"""
...
from workspaces.alignment_prototype.pitch_detune import (
    SR,
    VOCAL_FMAX,
    VOCAL_FMIN,
    estimate_cents,
...
# run from the repo root (python -m workspaces.alignment_prototype.measure_detune)
OUT_CSV = Path("workspaces/alignment_prototype/out/pitch_detune_clips.csv")

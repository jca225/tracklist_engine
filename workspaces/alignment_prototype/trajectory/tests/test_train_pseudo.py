...
from workspaces.alignment_prototype.trajectory.train import load_pseudo_train_yaml
...
def test_main_rejects_same_set_before_dataset(tmp_path, monkeypatch):
    from workspaces.alignment_prototype.trajectory import train as train_mod

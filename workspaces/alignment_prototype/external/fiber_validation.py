...
Usage:
  venvs/audio/bin/python -m workspaces.alignment_prototype.external.fiber_validation \\
...
from workspaces.alignment_prototype.refine_ref_offsets import HOP, SR, chroma  # noqa: E402

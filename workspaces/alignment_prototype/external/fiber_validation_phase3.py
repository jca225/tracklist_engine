...
Usage:
  venvs/audio/bin/python -m workspaces.alignment_prototype.external.fiber_validation_phase3 [--sweep]
...
from workspaces.alignment_prototype.continuity_refine import _compute_hubert  # noqa: E402
from workspaces.alignment_prototype.external.fiber_validation import (  # noqa: E402
    _AUDIO_CACHE,
    _FEAT_CACHE,
    _OUT,
    FPS,
...
from workspaces.alignment_prototype.ref_fibers import compute_fibers  # noqa: E402
...
def _harm_labels_cfg(path: str, cfg_name: str, kw: dict) -> tuple[np.ndarray, float]:
    ...
    from workspaces.alignment_prototype.harmony_fibers import harmony_fibers

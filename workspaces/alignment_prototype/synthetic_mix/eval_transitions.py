...
Usage:
  venvs/audio/bin/python -m workspaces.alignment_prototype.synthetic_mix.eval_transitions \\
...
from workspaces.alignment_prototype.synthetic_mix.transition_probe import (
    windowed_recover,
)

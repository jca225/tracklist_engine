...
Usage:
  venvs/audio/bin/python -m workspaces.alignment_prototype.synthetic_mix.transition_pathdecode \\
...
from workspaces.alignment_prototype.path_decode import FPS, decode_path
from workspaces.alignment_prototype.refine_ref_offsets import SR, chroma
from workspaces.alignment_prototype.synthetic_mix.transition import (
    TempoRide,
    recovered_curve_error,
    render_ride,
)
from workspaces.alignment_prototype.synthetic_mix.transition_probe import CURVATURES

...
side cache (workspaces/alignment_prototype/.cache/fp_instr/), mirroring
scripts/backfill_track_fingerprints.py.

Usage:
    venvs/audio/bin/python -m workspaces.alignment_prototype.instrumental_probe \
        --set bb11 --set bb12
    # or a single set:
    venvs/audio/bin/python -m workspaces.alignment_prototype.instrumental_probe --set bb12
"""
...
from workspaces.alignment_prototype.fp_index import FpKey, load_cached, save_cached
...
from workspaces.alignment_prototype.mix_fp_hits import _vote_pairs, offset_candidates
...
def decode_instr_placements(
    ...
    *,
    ...
    """
    from workspaces.alignment_prototype.mix_fp_hits import decode_placements

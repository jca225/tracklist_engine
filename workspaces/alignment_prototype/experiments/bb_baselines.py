...
# Lifted into the shared module (workspaces/alignment_prototype/timeline_provenance.py).
# Re-exported here so existing call sites and tests resolve without modification.
from workspaces.alignment_prototype.timeline_provenance import (  # noqa: E402
    _git_sha,
    cohort_spread_s,
    driver_provenance,
)

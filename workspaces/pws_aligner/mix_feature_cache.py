...
def _default_mix_chroma_window(mix: MixContext):
    from workspaces.alignment_prototype.harness.chroma_probe import _default_chroma
...
def _default_mix_hubert_window(mix: MixContext):
    from workspaces.alignment_prototype.harness.hubert_probe import _default_hubert
...
class MixFeatureCache:
    ...
    def _build_one(self, name: str):
        ...
        if name == "chroma":
            from workspaces.alignment_prototype.harness.chroma_probe import ChromaProbe
        ...
        if name == "hubert":
            from workspaces.alignment_prototype.harness.hubert_probe import HubertProbe

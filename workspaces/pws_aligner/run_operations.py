...
Usage
-----
    venvs/audio/bin/python -m workspaces.pws_aligner.run_operations \\
        --set-id 1fsnxchk

Output: workspaces/alignment_prototype/out/<set_id>_operation_votes.json
"""
...
_DEFAULT_OUT_DIR = _REPO / "workspaces" / "alignment_prototype" / "out"
...
def run_operations(
    ...
    *,
    ...
    from workspaces.pws_aligner.operations import keylock_vs_varispeed
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument(
        ...
        help=(
            ...
            "(default: workspaces/alignment_prototype/out/<set_id>_operation_votes.json)"
        ),
    )

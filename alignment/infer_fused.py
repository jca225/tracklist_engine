...
predicted-timeline JSON next to the review tooling's format.
    ...
    venvs/audio/bin/python -m alignment.infer_fused \\
...
from alignment.landmark_fp import (  # noqa: E402
    FHOP,
    SR,
    constellation,
    hashes,
...
from alignment.refine_ref_offsets import find_aligning_dir  # noqa: E402

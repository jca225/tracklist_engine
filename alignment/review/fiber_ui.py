...
Usage:
    venvs/audio/bin/python -m alignment.review.fiber_ui \
...
from alignment.path_decode import _ensure_feat  # noqa: E402
from alignment.ref_fibers import (  # noqa: E402
    _diag_sim,
    compute_fibers,
    compute_fibers_fp,
    fiber_intervals,
...
def main(argv: list[str] | None = None) -> int:
    ...
    out_dir = _REPO / f"alignment/out/fiber_review/{args.set_id}"

...
Example (instrumental landmark):
    ...
    venvs/audio/bin/python -m alignment.fp_segments.run \
      --set-id 2nvzlh2k \
...
Example (vocal HuBERT):
    ...
    venvs/audio/bin/python -m alignment.fp_segments.run \
      ...
      --output alignment/out/fp_segments/2nvzlh2k_vocal_hubert.json
...
from alignment.fp_index import DEFAULT_CACHE_DIR, FpKey
from alignment.fp_index import load as load_ref_fp
from alignment.fp_placement_refine import find_aligning_dir
from alignment.infer import _manifest_by_tid, _vocal_ref_path

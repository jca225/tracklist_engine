...
Usage:
    venvs/audio/bin/python -m alignment.fibers.gt_als \
...
from alignment.fibers.detect import (
    compute_fibers_fp,
    compute_fibers_soft,
    fiber_intervals,
)
from alignment.fibers.harmony import harmony_fibers
...
def clone_verdict(
    ...
    from alignment.looptrace.selfsim import (
        RepeatPair,
        residual_db,
        verify_pair,
...
def render(
    ...
    from alignment.fibers.detect import FIBER_VERSION

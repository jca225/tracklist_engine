...
from alignment.continuity_refine import (  # noqa: E402
    _FEAT_CACHE,
    _compute_hubert,
)
...
def _ensure_feat(audio_path, src_key, feature: str, layer: int) -> Path:
    ...
    if feature == "hubert":
        ...
        from alignment.continuity_refine import _hubert_cache_path
...
def trajectory_acc(
    ...
    from alignment.ref_fibers import same_fiber
...
def main(argv: list[str] | None = None) -> int:
    ...
    from alignment.ref_fibers import fiber_ambiguity

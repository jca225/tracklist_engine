...
Scripts still run in place (`python -m alignment.attic.<name>`);
...
DJ/DAW tool ontology). Infra kept in `pws_aligner/` (capture,
...
**Infra:** `alignment/daw_env/` — Mode A/B CLI, unit tests

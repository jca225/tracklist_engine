...
Usage:
    venvs/audio/bin/python -m alignment.eval_placement \
...
from alignment.fp_index import FpKey, load as fp_load
from alignment.landmark_fp import SR, constellation, hashes
from alignment.mix_fp_hits import decode_placements, load_mix_mono

...
class HybridMlDriver:
    ...
    def align_set(self, ctx: SetContext) -> Path:
        ...
        from alignment.recon_probe import find_aligning_dir
        from alignment.trajectory.decode import viterbi_segments
        ...
        from alignment.trajectory.model import TrajectoryDecoder
    ...
    def _load_model(self, ctx: SetContext, device):
        ...
        if not Path(ckpt).is_file():
            raise FileNotFoundError(
                ...
                f"  venvs/audio/bin/python -m alignment.trajectory.train "

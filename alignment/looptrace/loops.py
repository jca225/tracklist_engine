...
with the GT answer key:
    venvs/audio/bin/python -m alignment.looptrace.loops \
...
from alignment.looptrace.config import LOOP_V2, LoopConfig
...
def main(argv: list[str] | None = None) -> int:
    ...
    from alignment.path_decode import find_aligning_dir

...
from alignment.agentic.actions import REGISTRY, Runner
from alignment.agentic.belief import Observation, fiber_gate
...
class LiveContext:
    ...
    def ref_hub(self, recording_id: str):
        ...
        from alignment.stem_placement import hubert_of
...
def stem_hubert_runner(ctx: LiveContext) -> Runner:
    ...
    def _run(data: dict) -> Observation:
        from alignment.stem_placement import place_joint

...
from alignment.fibers.detect import fiber_at, fiber_intervals
from alignment.landmark_fp import FHOP as _FHOP
from alignment.landmark_fp import SR as _SR
from alignment.path_decode import FPS as _FPS
from alignment.path_decode import _scores_at_stretch
...
def build_population(
    ...
    *,
    ...
    from alignment.path_decode import trajectory_acc
...
def _fibers_hard(ref_audio: str) -> tuple:
    ...
    from alignment.fibers.detect import compute_fibers
...
def _fibers_soft(ref_audio: str) -> tuple:
    ...
    from alignment.fibers.detect import compute_fibers_soft
    from alignment.path_decode import FPS, _ensure_feat
...
def main(argv: list[str] | None = None) -> int:
    ...
    from alignment.score_timeline_vs_gt import _REPO as repo
    ...
    r0_of = {
        "1fsnxchk": repo
        / "alignment/out/1fsnxchk_predicted_timeline_lt.json",
        "2nvzlh2k": repo
        / "alignment/out/2nvzlh2k_predicted_timeline_lt.json",
    }

...
Usage:
    venvs/audio/bin/python -m alignment.neuro.precision_fusion_lyrics_eval \
        [--max-win-s 15]
"""
...
from alignment.neuro.precision import (
    SR,
    detect_offset_curve,
    precision_from_curve,
)
from alignment.refine_ref_offsets import STRETCHES, chroma

...
identity-correct spans.
    ...
    venvs/audio/bin/python -m alignment.experiments.bb_baselines
    venvs/audio/bin/python -m alignment.experiments.bb_baselines \
...
_REPO = Path(__file__).resolve().parent.parent.parent  # experiments->…->repo
...
from alignment.score_timeline_vs_gt import score_spans  # noqa: E402

OUT_DIR = _REPO / "alignment" / "out"

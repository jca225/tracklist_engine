...
from alignment.agentic.loop import SpanCtx
from alignment.agentic.policy import Ladder
from alignment.drivers.agentic import refine_agentic_spans
from alignment.drivers.base import (
    finalize,
    load_timeline_dict,
    preflight_set,
)
from alignment.trajectory.data import GT_FIXTURES
from alignment.trajectory.pseudo_materialize import (
...
def build_train_commands(cfg: E1Config, pseudo_yaml: Path) -> list[list[str]]:
    ...
    py = sys.executable
    mod = "alignment.trajectory.train"
...
def _produce_agentic_timeline(cfg: E1Config, aligning: Path) -> Path:
    ...
    from alignment.agentic.novelty import surprise_runner_for_set

...
from alignment.trajectory import trm
from alignment.trajectory.decode import TrajectoryEvidence
from alignment.trajectory.offset_coords import OffsetVocab
...
def test_offset_targets_from_ref_bin_targets():
    ...
    from alignment.trajectory.offset_coords import IGNORE_INDEX

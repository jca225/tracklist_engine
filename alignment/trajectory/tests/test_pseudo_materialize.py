...
def test_materialize_exit_code_starvation_via_cli(tmp_path):
    from alignment.trajectory.pseudo_materialize import main
...
def test_materialize_yaml_loads_into_dataset_when_audio_stubbed(tmp_path, monkeypatch):
    from alignment.trajectory import data as traj_data
    from alignment.trajectory.features import SpanAudio

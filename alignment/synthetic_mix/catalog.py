...
except ImportError as _e:  # mashup_compat attic'd in focus cut
    raise ImportError(
        "alignment.synthetic_mix.catalog needs attic'd mashup_compat; "
        "restore from git history if you need this probe"
    ) from _e

...
# lab/corpus_empirics/bb_popularity.py:pull_bb_meta() (which runs a one-time SQL extract,
...
def pull_bb_spotify_ids() -> dict[str, str]:
    ...
    if not BB_META_CSV.exists():
        print(f"ERROR: {BB_META_CSV} not found. Run lab/corpus_empirics/bb_popularity.py first "

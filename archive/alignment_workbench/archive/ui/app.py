...
def _aligned_rows_for(set_id: str, *, source: str | None = None) -> pd.DataFrame:
    ...
    from archive.audio_pipeline.alignment.stem_mask import BADGE, classify, parse_version_tag
...
def _render_not_aligned_panel(set_id: str, aligned_df: pd.DataFrame) -> None:
    ...
    from archive.audio_pipeline.adapters.downloader import DownloadConfig, download_one
...
# ---------- SET DETAIL -------------------------------------------------------
    ...
    if not set_audio_row or not Path(set_audio_row[0]).exists():
        from archive.audio_pipeline.models import normalize_set_media_url
...
# ============================================================================
    ...
    from archive.audio_pipeline.models import youtube_url as _yt_url
    from archive.audio_pipeline.models import soundcloud_api_url as _sc_url
    from archive.audio_pipeline.models import spotify_track_url as _sp_url
        ...
        with pc2:
            ...
            if not variants:
                ...
                if not pick_tid:
                    ...
                    # isn't touched.
                    from archive.audio_pipeline.adapters import db as _gt_db
                    from archive.audio_pipeline.adapters.downloader import (
